...
import 'package:digitaldisplay/views/screens/Layout/EditProductLayout.dart';
...
class _EditProductState extends State<EditProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: const EditProductLayout(
          mobileBody: CreateProductMobile(),
          tvBody: CreateProductTv(),
        ));
  }
